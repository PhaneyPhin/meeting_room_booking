    ...
    constructor() {
        ...
        this.bookingRoom = (req, res, next) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.execute(`insert into booking_master values ($1,$2,$3,$4,$5,$6,$7,$8,'1',$9,$10,$11,$12,$13)`, [booking_id, booking_description, username, room_id, start_date, end_date, status, moment_1.default().format("YYYY-MM-DD HH:mm:ss"), important, member, remark, tel, sub_department_id]);
        ...
        this.getCurrentReservationTask = (req, res, next) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                var currents = yield this.getOfDB(`select   u.first_name,u.last_name,b.start_date,b.end_date,b.booking_description from booking_master b left join sub_department_master sd 
                            on b.sub_department_id=sd.sub_department_id
                            left join department_master d on
                            sd.department_id=d.department_id  left join user_master u on b.username=u.username inner join room_master r on r.room_id=b.room_id where status_id='2' and r.room_name=$1 and b.end_date>=$2 and b.end_date<=$3 and b.flag='1' order by b.start_date`, [room_number, moment_1.default().format("YYYY-MM-DD HH:mm:ss"), moment_1.default().format("YYYY-MM-DD") + " 23:59:59"]);
        ...
        this.getCurrentTask = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                var nexts = yield this.getOfDB(`select   u.first_name,u.last_name,b.start_date,b.end_date,b.booking_description from booking_master b left join sub_department_master sd 
                    on b.sub_department_id=sd.sub_department_id
                    left join department_master d on
                    sd.department_id=d.department_id  left join user_master u on b.username=u.username inner join room_master r on r.room_id=b.room_id where status_id='2' and r.room_name=$1 and b.start_date>=$2 and b.end_date<=$3 order by b.start_date`, [room_number, moment_1.default(currents[0].end_date).format("YYYY-MM-DD HH:mm:ss"), moment_1.default().format("YYYY-MM-DD") + " 23:59:59"]);
                if (currents.length > 0) {
        ...
        this.getBooking = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                var books = yield this.getOfDB(`select * from booking_master b left join sub_department_master sd 
                on b.sub_department_id=sd.sub_department_id
                left join department_master d on
        ...
        this.getRoomBooking = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                var books = yield this.getOfDB(`select b.booking_description as subject,b.start_date,b.end_date,u.first_name,u.last_name from booking_master b left join sub_department_master sd 
                on b.sub_department_id=sd.sub_department_id
                left join department_master d on

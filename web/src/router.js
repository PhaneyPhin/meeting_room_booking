...

    {
      ...
      children: [
        ...
        },
        {
          path: '/department',
          name: 'dashboardECommerce',
          component: () => import('./views/subdepartment/subdepartment.vue'),
          meta: {
            rule: 'admin'
          }
        },
        ...
        },
        {
          path: '/book_room',
          name: 'room',
          component: () => import('./views/book_room.vue'),
          meta: {
            rule: 'member'
          }
        },
        ...
        },
        {
          path: '/schedule1',
          name: 'room',
          component: () => import('./views/Schedule1.vue'),
          meta: {
            rule: 'member'
          }
        },
        {
          path: '/user_booking',
          name: 'room',
          component: () => import('./views/user_booking.vue'),
          meta: {
            rule: 'notAdmin'
          }
        },
        {
          path: '/all_booking',
          name: 'room',
          component: () => import('./views/all_booking.vue'),
          meta: {
            rule: 'approver'
          }
        },
        {
          path: '/all_my_booking',
          name: 'room',
          component: () => import('./views/all_my_booking.vue'),
          meta: {
            rule: 'member'
          }
        },
        {
          path: '/my_booking',
          name: 'room',
          component: () => import('./views/my_booking.vue'),
          meta: {
            rule: 'member'
          }
        },
        {
          path: '/booking_rejected',
          name: 'room',
          component: () => import('./views/booking_rejected.vue'),
          meta: {
            rule: 'approver'
          }
        },
        {
          path: '/my_booking_rejected',
          name: 'room',
          component: () => import('./views/my_rejected.vue'),
          meta: {
            rule: 'member'
          }
        },
        {
          ...
          name: 'room',
          component: () => import('./views/booking_history.vue'),
          meta: {
            rule: 'approver'
          }
        },
        {
          ...
          name: 'room',
          component: () => import('./views/my_booking_history.vue'),
          meta: {
            rule: 'member'
          }
        }, {
...
router.beforeEach((to, from, next) => {
  firebase.auth().onAuthStateChanged(() => {
    ...
    if (
      ...
      (service.isLoggedIn() || firebaseCurrentUser)
    ) {
      return next();
    }
